			...
			<div class="md:ml-24">
				...
				<div x-data="{ isOpen: false }">
					@if(count($movie['videos']['results']) > 0)
						<div class="mt-12">
							<button @click="isOpen = true" class="flex inline-flex items-center bg-orange-500 text-gray-900 font-semibold px-5 py-4 rounded hover:bg-orange-600 transition ease-in-out duration-150">
