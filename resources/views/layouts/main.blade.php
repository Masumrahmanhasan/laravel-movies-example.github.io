...
<body class="font-sans bg-gray-900 text-white">
	<nav class="border-b border-gray-800 ">
		<div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-6">
			<ul class="flex items-center flex-col md:flex-row">
				...
				<li class="md:ml-6 ml-6 mt-3 md:mt-0">
	...
	<footer class="border-t border-gray-800 mt-3">
		<div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-6">
			<div class="flex items-center flex-col md:flex-row">
				<p class="text-gray-400 hover:text-gray:300">All Rights Reserved &copy;Masum Rahman Hasan</p>
			</div>
			<div class="flex items-center flex-col md:flex-row">
				<p class="text-orange-400 hover:text-orange:300">Design And Developed By Masum Rahman Hasan</p>
			</div>
		</div>
	</footer>
