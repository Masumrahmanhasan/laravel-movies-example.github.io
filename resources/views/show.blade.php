	...
	<div class="movie-info border-b border-gray-800">
		<div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
			...
			<div class="md:ml-24">
				...
				<div class="mt-12">
					<a href="https://www.youtube.com/embed/{{ $movie['videos']['results'][0]['key'] }}" class="flex inline-flex items-center bg-orange-500 text-gray-900 font-semibold px-5 py-4 rounded hover:bg-orange-600 transition ease-in-out duration-150">
		...
		<div class="container mx-auto px-4 py-16">
			...
			<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
				@foreach ($movie['credits']['cast'] as $cast)
					...
					@if($loop->index < 10 && $cast['profile_path'] != null)
						<div class="mt-8">
							<a href="#">
